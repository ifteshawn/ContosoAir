[![Build Status](https://dev.azure.com/ifteshawn94/ifteshawn/_apis/build/status%2Fifteshawn.ContosoAir?branchName=master)](https://dev.azure.com/ifteshawn94/ifteshawn/_build/latest?definitionId=1&branchName=master)
